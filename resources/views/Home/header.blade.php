...
<header class="bg-gradient-dark">
    <div class="page-header min-vh-75" style="background-image: url('assets/img/boniaga.jpg'); background-size: cover; background-position: center;">
        <span class="mask bg-gradient-dark opacity-6"></span>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center mx-auto my-auto">
                    <h1 class="text-white fw-bold">Toko Boniaga</h1>
                    <p class="lead mb-4 text-white opacity-9">
                    ...
                    <a href="#produk" class="btn btn-light text-dark fw-semibold px-4 py-2">Selengkapnya</a>
                    <!-- <h6 class="text-white mb-2 mt-5">Temukan kami di</h6> -->
